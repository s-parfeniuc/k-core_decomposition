...
push dal nodo che ha cambiato il proprio estimate, il nodo calcola il nuovo estimate e in caso di aggiornamento
...
statico del compilatore facendoli in runtime; Rc, reference counter, che permette di clonare un riferimento a un oggetto
contando il numero di riferimenti presenti in runtime.
*/
